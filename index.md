...
![Github stars](https://img.shields.io/github/stars/teymurov27/SPI-Arduino.svg?style=social&label=Star&maxAge=2592000) [![Open in Visual Studio Code](https://open.vscode.dev/badges/open-in-vscode.svg)](https://open.vscode.dev/teymurov27/SPI-Arduino)
...
If you don't have VS Code you can install from [here](https://code.visualstudio.com/download). After downloading click extensions and type and install **PlatformIO IDE**. Then *select* your arduino board and *upload*. Source codes have to be located in */src* folder, so if you want to upload slave code then *move* **master.cpp** to */test* and **slave.cpp** back to */src* folder. Libraries are located in */lib*.
